...
@Component({
  ...
  template: `
    ...
    <div style="display:flex;min-height:100vh;">
      <aside style="width:64px;background:#f5f5f5;box-shadow:1px 0 4px #0001;display:flex;flex-direction:column;align-items:center;position:fixed;top:0;left:0;bottom:0;z-index:1100;">
        <app-sidenav />
      </aside>
